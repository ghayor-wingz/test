...
export default function ScalingFormSection() {
  ...
  return (
    <section className="bg-slate-50 py-18 md:py-40 px-4">
      <div className="page-width">
        <div className="flex flex-col-reverse items-center gap-14 lg:grid lg:grid-cols-2 lg:items-center">
          ...
          <div className="w-full">
            <h2 className="mb-8 text-center text-[32px] md:text-4xl font-semibold leading-tight text-slate-900 lg:text-left">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 max-sm:flex max-sm:flex-col max-sm:items-center">
              ...
              <PrimaryButton
                ...
                className={`flex h-12 w-full items-center justify-center text-[20px] font-medium leading-[115%] tracking-[0.2px] transition ${
                  isSubmitting
                    ? 'bg-slate-300 text-black'
                    : isSuccess
                    ? 'bg-green-400 !text-black'
                    : 'bg-[#F3F757] !text-black'
                }`}
              >
                {isSubmitting ? (
